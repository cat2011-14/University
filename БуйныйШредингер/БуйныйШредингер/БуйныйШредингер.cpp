...
// БуйныйШредингер.cpp : Определяет поведение классов для приложения.
//

#include "stdafx.h"
#include "БуйныйШредингер.h"
#include "БуйныйШредингерDlg.h"
...
BEGIN_MESSAGE_MAP(CБуйныйШредингерApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CБуйныйШредингерApp

CБуйныйШредингерApp::CБуйныйШредингерApp()
{
...
// Единственный объект CБуйныйШредингерApp

CБуйныйШредингерApp theApp;


// инициализация CБуйныйШредингерApp

BOOL CБуйныйШредингерApp::InitInstance()
{
