...
// обработчики сообщений CrazyW

void CrazyW::Масштабирование(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
void CrazyW::Параметры(vector<double>Данные, double R0max)
{
	Xmax = R0max;
	Xmin = -R0max;
...
void CrazyW::Прорисовка(Graphics &БитКарта)
{
