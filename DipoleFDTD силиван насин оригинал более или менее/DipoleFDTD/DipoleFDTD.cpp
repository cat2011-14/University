...
// DipoleFDTD.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDipoleFDTDApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDipoleFDTDApp

CDipoleFDTDApp::CDipoleFDTDApp()
{
...
// Единственный объект CDipoleFDTDApp

CDipoleFDTDApp theApp;


// инициализация CDipoleFDTDApp

BOOL CDipoleFDTDApp::InitInstance()
{
